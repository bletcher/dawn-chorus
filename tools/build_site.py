  ...
  <section class="rung" data-rung="selection">
    ...
    <div class="rbody">
      ...
      <section class="card" data-card="table">
        ...
        <div class="about" hidden><p>Aggregated over the selection: mornings present, total detections, and median onset/offset/span/peak/occupancy in minutes from civil dawn. Hover a column heading for its definition; click a species to hear it.</p></div>
