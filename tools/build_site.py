...
function renderEcdf(S){
  ...
  el.append(Plot.plot({ width:W(el), height:410, marginLeft:ML(el,false), marginRight:20, style:plotStyle(),
    x:xAxis({grid:true}),
...
function renderWeather(S, key, elId, xlabel, card){
  ...
  el.append(Plot.plot({ width:W(el), height:360, marginLeft:ML(el,false)+2, marginRight:20, style:plotStyle(),
...
function renderSeason(){
  ...
  const fig=Plot.plot({ width:W(el), height:420, marginLeft:ML(el,false)+4, marginRight:20, style:plotStyle(),
